...
<%
	...
	try {
	noticeList5 = (List<NoticeDTO>) session.getAttribute("noticeList5");
%>
...
<body>
   <header>
        ...
        <main>
            ...
            height: 600px;
            z-index: 1;">
			<img width="100%" height="600px"src="img/main_banner.png">
            </div>
            <!-- 메인 전시 부분 -->
            <div class="main_exhibition_title"><h1>진행 중인 이벤트</h1></div>
            <div>
                <ul class="main_exhibition_content">
                    <li class="main_exhibition_element"><a href="#"><img src="img/event1.jpg"></a></li>
                    <li class="main_exhibition_element"><a href="#"><img src="img/event2.jpg"></a></li>
                    <li class="main_exhibition_element"><a href="#"><img src="img/event3.jpg"></a></li>
            ...
            <div class="main_board">
                <div class="main_notice">
                    <h2><a href="getNoticeList.no">NOTICE</a></h2>
                    <ul>
                    	<%
							for (NoticeDTO i : noticeList5) {
						%>
                        <li><a href="getNotice.no?noticeID=<%= i.getNoticeID()%>"><%= i.getNoticeTitle() %></a></li>
                        <%
							} session.removeAttribute("noticeList5");
						} catch (Exception e) {
                ...
                <div class="main_qna">
                    <h2><a href="getQnaList.qa">QNA</a></h2>
                    <ul>
                        <li><a href="#"> 최근질문1</a></li>
                        <li><a href="#"> 최근질문1</a></li>
                        <li><a href="#"> 최근질문1</a></li>
                        <li><a href="#"> 최근질문1</a></li>
                        <li><a href="#"> 최근질문1</a></li>
