...
<body>
   <header>
        ...
        <main>
            ...
            <form method="post" action="insertNotice.no">
            <table class="insert_board">
				...
				<tbody>
                    <tr>
                        ...
                        <td><input type="text" class="input_2 al" id="noticetitle" name="noticetitle"></td>
                    </tr>
                    <tr>
                        <td style="text-align: center;">내용</td>
                        <td><textarea class="input_area" rows="10" id="noticecontent" name="noticecontent"></textarea></td>
                    </tr>
                    <tr>
