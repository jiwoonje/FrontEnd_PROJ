...
<body>
   <header>
        ...
        <main>
            ...
            <form method="post" action="updateNotice.no">
            <input type="hidden" name="noticeID" value="<%=notice.getNoticeID()%>">
            <table class="insert_board">
                <thead>
					<tr>
						<th scope="col" colspan="2">수정하기</th>
					</tr>
				</thead>
				<tbody>
					<tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="input_2 al" id="noticetitle" name="noticetitle" value="<%= notice.getNoticeTitle()%>"></td>
                    </tr>
                    <tr>
                        <td style="text-align: center;">내용</td>
                        <td><textarea class="input_area" rows="10" id="noticecontent" name="noticecontent"><%= notice.getNoticeContent()%></textarea></td>
                    </tr>
                    <tr>
