...
<body>
   <header>
        ...
        <main>
            ...
            <form method="post" action="insertQna.qa">
            <input type="hidden" name="nickname" value="<% out.print(nickname); %>">
            <table class="insert_board">
				...
				<tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="input_2 al" id="qnatitle" name="qnatitle"></td>
                    </tr>
                    <tr>
                        <td style="text-align: center;">내용</td>
                        <td><textarea class="input_area" rows="10" id="qnacontent" name="qnacontent"></textarea></td>
                    </tr>
                    <tr>
                        <td colspan="4" style="text-align: center;">
                            <button type="submit" class="btn_navy">등록</button>
                        </td>
                    </tr>
				</tbody>
            </table>
