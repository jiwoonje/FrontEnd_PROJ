...
<body>
   <header>
        ...
        <main>
            ...
            <form method="post" action="updateQna.qa">
            ...
            <table class="insert_board">
				...
				<tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="input_2 al" id="qnatitle" name="qnatitle" value="<%= qna.getQnaTitle()%>"></td>
                    </tr>
                    <tr>
                        <td style="text-align: center;">내용</td>
                        <td><textarea class="input_area" rows="10" id="qnacontent" name="qnacontent"><%= qna.getQnaContent()%></textarea></td>
                    </tr>
                    <tr>
