    ...
    <header>
        ...
        <main>
            ...
            <div class="main_box_2">
                <!-- 회원가입 박스 -->
                <form class="join_box" method="post" action="insertUser.us">
                    <br>
                    <p class="login_title">회 원 가 입</p>
                    <br>
                    <input type="text" id="id" name="userID" class="id_box" placeholder="ID" required>
                    <input type="password" id="password" name="password" class="id_box" placeholder="Password" required>
                    <input type="text" id="nickname" name="nickname" class="id_box" placeholder="Nickname" required>
                    <input type="text" id="lastname" name="lastname" class="id_box" placeholder="Last Name" required>
                    <input type="text" id="firstname" name="firstname" class="id_box" placeholder="First Name" required>
                    <input type="email" id="email" name="email" class="id_box" placeholder="E-mail" required>
                    <input type="tel" id="phonenumber" name="phonenumber" class="id_box" placeholder="Phone Number" required>
                    <br>
                    <input type="submit" class="btn" value="등 록">
                </form>
            </div>
        </main>
        <footer>
